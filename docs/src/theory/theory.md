...
The general form of the multivariate (univariate) mixed effects model for individual $i$ from $n$ individuals with complete genomic data in NNMM is
...
of freedom. *(A fast and efficient Gibbs sampler was implemented for BayesB in NNMM.)*
